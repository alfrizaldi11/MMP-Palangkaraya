              ...
              <div class="row">
                ...
                <div class="card shadow mb-4">
                  <div class="card-header py-3">
                      <h4 class="font-weight-bold text-danger">Tambah Data Permintaan Branding</h4>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <div class="card-body">
                    ...
                    <form enctype='multipart/form-data' action="aksi_tambah_branding.php" method="POST">
                      <div class="box-body">

                        <div class="form-group">
                          <label>Waktu Permintaan</label>
                          <input name="w_request" type="date" class="form-control" placeholder="Masukkan waktu permintaan" required>
                        </div>

                        <div class="form-group">
                          <label>Waktu Selesai</label>
                          <input name="w_selesai" type="date" class="form-control" placeholder="Masukkan waktu selesai" required>
                        </div>

                        <div class="form-group">
                            <label>Nama Outlet</label>
                            <select name="id_outlet" class="form-control selectpcker" data-size="4" required>
                              <option value="">-- Pilih Outlet --</option>
                                            <?php
                                            while($t=mysqli_fetch_array($outlet)){
                        ...
                        <div class="form-group">
                          <label>Jumlah</label>
                          <input name="jumlah" type="number" class="form-control" placeholder="Masukkan jumlah" required>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <input disabled value="<?php echo $_SESSION['nama_user']; ?>" type="text" class="form-control" placeholder="Masukkan Username(jika kosong masukan '-')" required>
