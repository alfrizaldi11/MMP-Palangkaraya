          ...
          <div class="row">
            ...
            <div class="card shadow mb-4">
              <div class="card-header py-3">
                  <h4 class="font-weight-bold text-danger">Tambah Data Outlet</h4>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <div class="card-body">
                <form enctype='multipart/form-data' action="aksi_tambah_outlet.php" method="POST">
                  <div class="box-body">
                    <div class="form-group">
                      <label>Nama Outlet</label>
                      <input name="nama_outlet" type="text" class="form-control" placeholder="Masukkan nama outlet (jika kosong masukan '-')" required>
                    </div>
                    
                    <div class="form-group">
                      <label>Nama Owner</label>
                      <input name="nama_owner" type="text" class="form-control" placeholder="Masukkan nama owner(jika kosong masukan '-')" required>
                    </div>

                    <div class="form-group">
                      <label>Nomor Telepon</label>
                      <input name="no_tlp" type="number" class="form-control" placeholder="Masukkan nomor telepon(jika kosong masukan '-')" required>
                    </div>

                    <div class="form-group">
                      <label>Alamat Outlet</label>
                      <input name="alamat" type="text" class="form-control" placeholder="Masukkan alamat outlet(jika kosong masukan '-')" required>
                    </div>
